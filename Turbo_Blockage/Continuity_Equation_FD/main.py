...
for dist in BLOCKAGE_FUNCS:
    ...
    plt.plot(domain.x, u_original, 'o', mfc='none', label='original')
    plt.plot(domain.x, u_separated, '^', mfc='none', label='separated')
    plt.xlabel('x')
    plt.ylabel('Velocity')
    plt.grid(alpha=0.3)
    plt.legend()
    ...
    plt.plot(domain.x, u_original*rho*A*b, 'o', mfc='none', label='original')
    plt.plot(domain.x, u_separated*rho*A*b, '^', mfc='none', label='separated')
    plt.xlabel('x')
