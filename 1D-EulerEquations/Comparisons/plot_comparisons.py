...
for i in [0,]:
    ...
    ax[0, 0].plot(waf.xNodes, waf.solution['Density'][1:-1, -1], '-C2o', ms=2, mfc='none', label='WAF')  # don't plot the halo nodes
    ax[0, 0].plot(roe.xNodes, roe.solution['Density'][1:-1, -1], '-C3o', ms=2, mfc='none', label='Roe')  # don't plot the halo nodes
    ...
    ax[0, 1].plot(waf.xNodes, waf.solution['Velocity'][1:-1, -1], '-C2o', ms=2, mfc='none', label='WAF')
    ax[0, 1].plot(roe.xNodes, roe.solution['Velocity'][1:-1, -1], '-C3o', ms=2, mfc='none', label='Roe')
    ...
    ax[1, 0].plot(waf.xNodes, waf.solution['Pressure'][1:-1, -1], '-C2o', ms=2, mfc='none', label='WAF')
    ax[1, 0].plot(roe.xNodes, roe.solution['Pressure'][1:-1, -1], '-C3o', ms=2, mfc='none', label='Roe')
    ...
    ax[1, 1].plot(waf.xNodes, waf.solution['Energy'][1:-1, -1], '-C2o', ms=2, mfc='none', label='WAF')
    ax[1, 1].plot(roe.xNodes, roe.solution['Energy'][1:-1, -1], '-C3o', ms=2, mfc='none', label='Roe')
